...
The fastest and best way to create new projects with Crawlee is to use the [Crawlee CLI](https://www.npmjs.com/package/@vladfrangu-dev/crawlee-cli). You can use the `npx` utility to download and run the CLI - it is embedded in the `crawlee` package:
...
INFO  PlaywrightCrawler: Title of https://crawlee.dev/api/core is '@vladfrangu-dev/crawlee-core | API | Crawlee'
